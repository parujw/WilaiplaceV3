...
export interface Lease {
  ...
  endedReason?: string;
  /**
   * ย้ายห้อง — สองฟิลด์นี้ร้อยสัญญาของการเช่าครั้งเดียวกันเข้าด้วยกัน
   *
   * ย้ายห้องไม่ใช่การแก้ roomId ของสัญญาเดิม เพราะบิลที่ออกไปแล้วชี้มาที่ leaseId
   * กับ roomId ย้ายปลายทางเมื่อไหร่ บิลเดือนก่อนของห้อง 502 จะกลายเป็นของห้อง 503
   * จึงปิดสัญญาเดิมแล้วเปิดใหม่ แล้วโยงกันด้วยสองฟิลด์นี้
   *
   * มีไว้เพื่อสองเรื่องที่ขาดไม่ได้
   *   เงินประกันที่ยกไปสัญญาใหม่ ไม่ใช่เงินที่หายไป — ดูได้จาก transferredTo
   *   ยอดค้างเก่ายังตามตัวคนไปห้องใหม่ แต่ไม่ตกใส่ผู้เช่าใหม่ของห้องเดิม
   */
