...
/** กราฟแท่งขาขึ้น — หน้าวิเคราะห์และประมาณการ */
export const IconChart = ({ className = base }: P) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
    ...
    <path d="M8 17v-4M12.5 17V9M17 17v-6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    <path d="m8 9 4.5-4 4.5 2.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
